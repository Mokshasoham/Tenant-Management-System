...
export const authService = {
  ...
  googleAuth: (idToken, role) => apiClient.post('/auth/google', { idToken, role }),
...
export const tenantService = {
  ...
  getMyTenantContext: () => apiClient.get('/tenants/my-context'),
...
export const paymentService = {
  ...
  getRentSummary: (params) => apiClient.get('/payments/rent-summary', { params }),
  createRentOrder: (data) => apiClient.post('/payments/create-order', data),
  verifyRazorpayPayment: (data) => apiClient.post('/payments/verify-razorpay', data),
...
export const payoutService = {
  ...
  saveBankAccount: (data) => apiClient.post('/payouts/bank-account', data),
...
export const verificationService = {
  ...
  getActivePropertyVerification: (propertyId) => apiClient.get(`/verifications/property/${propertyId}/active`),
  getLatestByEntity: (entityType, entityId) => apiClient.get(`/verifications/entity/${entityType}/${entityId}`),
