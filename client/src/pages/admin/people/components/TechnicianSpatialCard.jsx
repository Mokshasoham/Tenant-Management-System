    ...
    <div className={cn(
      ...
      <div className="grid grid-cols-3 gap-2 text-xs text-center pt-1 border-t border-border/40">
        <div>
          ...
          <p className="font-mono font-black text-indigo-400 text-xs">{technician.jobsCompleted}</p>
        </div>
        <div>
          <span className="text-[9px] text-muted-foreground font-bold block">On Time</span>
          <p className="font-mono font-black text-emerald-400 text-xs">{technician.onTimePercent}%</p>
        </div>
        <div>
          <span className="text-[9px] text-muted-foreground font-bold block">Avg Speed</span>
          <p className="font-mono font-black text-slate-300 text-xs">{technician.avgResolutionHours}h</p>
        </div>
      </div>
