...
export function NotificationCenter() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 p-4 sm:p-6 text-slate-100">
            {/* Header Title Banner */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gradient-to-r from-indigo-900/40 via-slate-900/60 to-purple-900/30 p-6 rounded-3xl border border-indigo-500/20 shadow-2xl backdrop-blur-xl">
                <div>
            ...
            <div className="flex items-center space-x-2 border-b border-slate-800 pb-2">
                <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2.5 rounded-xl font-semibold text-xs transition-all border ${
                        activeTab === 'all'
                            ? 'bg-slate-900 text-white border-indigo-500/50 shadow-md'
