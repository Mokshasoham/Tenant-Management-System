...
export function NotificationDropdownPopover({
    ...
    return (
        <div className="w-80 sm:w-96 bg-slate-900/95 border border-slate-700/80 rounded-2xl shadow-2xl backdrop-blur-xl overflow-hidden divide-y divide-slate-800 text-slate-100 z-50 animate-in fade-in zoom-in-95 duration-150">
            {/* Popover Header */}
            ...
            <div className="max-h-96 overflow-y-auto p-2 space-y-2 divide-y divide-slate-800/40">
                {loading ? (
