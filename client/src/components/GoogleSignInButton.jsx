    ...
    <div className="w-full flex justify-center">
      {isConfigured && !useFallback ? (
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl border border-border bg-card hover:bg-muted/50 text-foreground font-semibold text-sm flex items-center justify-center gap-3 transition-colors shadow-sm cursor-pointer"
        >
