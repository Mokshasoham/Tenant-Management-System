...
export const EventTypes = {
  ...
  VERIFICATION: {
    ...
    AADHAAR_VERIFIED: 'aadhaar.verification.verified',
    AADHAAR_FAILED: 'aadhaar.verification.failed',
    AADHAAR_LOCKED: 'aadhaar.verification.locked',
    AADHAAR_UNLOCKED: 'aadhaar.verification.unlocked',
    PAN_VERIFY_STARTED: 'pan.verification.started',
    PAN_VERIFIED: 'pan.verification.verified',
    PAN_MISMATCH: 'pan.verification.mismatch',
    PAN_FAILED: 'pan.verification.failed',
    PAN_LOCKED: 'pan.verification.locked',
    PAN_UNLOCKED: 'pan.verification.unlocked',
    GST_VERIFY_STARTED: 'gst.verification.started',
    GST_VERIFIED: 'gst.verification.verified',
    GST_INACTIVE: 'gst.verification.inactive',
    GST_FAILED: 'gst.verification.failed',
    GST_LOCKED: 'gst.verification.locked',
    GST_UNLOCKED: 'gst.verification.unlocked',
