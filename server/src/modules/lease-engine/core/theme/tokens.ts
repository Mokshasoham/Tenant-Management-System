...
export const typography = {
  ...
  display: { size: 24, weight: 'bold' as const },
  h1: { size: 14, weight: 'bold' as const },
  h2: { size: 11, weight: 'bold' as const },
  h3: { size: 9, weight: 'bold' as const },
  body: { size: 8, weight: 'normal' as const },
  bodyStrong: { size: 9, weight: 'bold' as const },
  table: { size: 8, weight: 'normal' as const },
  mono: { size: 8, weight: 'normal' as const },
