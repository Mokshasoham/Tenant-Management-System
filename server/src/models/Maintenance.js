...
const maintenanceSchema = new mongoose.Schema(
    {
        ...
        status: {
            type: String,
            enum: ['open', 'submitted', 'manager_review', 'technician_assigned', 'assigned', 'visit_scheduled', 'technician_en_route', 'work_started', 'waiting_parts', 'in_progress', 'completed_by_technician', 'awaiting_tenant_confirmation', 'completed', 'resolved', 'closed', 'cancelled'],
            default: 'open',
        },
        ticketCode: {
            type: String,
        ...
        completionStatus: {
            type: String,
            enum: ['pending', 'in_progress', 'completed_by_technician', 'awaiting_tenant_confirmation', 'resolved'],
            default: 'pending',
        },
        technicianId: {
        ...
        resolutionMethod: {
            type: String,
            enum: ['qr', 'ticket_id', 'manual', 'direct'],
        },
        auditLog: [{
