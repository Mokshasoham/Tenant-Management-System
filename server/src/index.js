...
import v1DashboardLayoutRoutes from './routes/v1DashboardLayoutRoutes.js';
import v1DashboardTemplateRoutes from './routes/v1DashboardTemplateRoutes.js';
...
app.use('/api/workforce', workforceSchedulingRoutes);
app.use('/api/v1/assignments', assignmentRoutes);
app.use('/api/assignments', assignmentRoutes);
app.use('/api/notifications', notificationRoutes);
app.use('/api/v1/notifications', v1NotificationRoutes);
app.use('/api/v1/reminders', v1ReminderRoutes);
app.use('/api/reminders', v1ReminderRoutes);
app.use('/api/v1/reports', v1ReportingRoutes);
app.use('/api/v1/reporting', v1ReportingRoutes);
app.use('/api/reports', v1ReportingRoutes);
app.use('/api/reporting', v1ReportingRoutes);
app.use('/api/v1/operations', v1OperationsRoutes);
app.use('/api/operations', v1OperationsRoutes);
app.use('/api/v1/telemetry', v1TelemetryRoutes);
app.use('/api/telemetry', v1TelemetryRoutes);
app.use('/api/v1/dashboard-layouts', v1DashboardLayoutRoutes);
app.use('/api/v1/dashboard-templates', v1DashboardTemplateRoutes);
